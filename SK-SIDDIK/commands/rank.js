...
module.exports.makeRankCard = async (data) => {    
	...
	const __root = path.resolve(__dirname, "Siddik");
	const PI = Math.PI;
	...
	const pathCustom = path.resolve(__dirname, "Siddik", "customrank");
...
module.exports.onLoad = async function () {
	...
	const path = resolve(__dirname, "Siddik", "customrank");
    if (!existsSync(path)) mkdirSync(path, { recursive: true });
 
    if (!existsSync(resolve(__dirname, 'Siddik', 'regular-font.ttf'))) await downloadFile("https://raw.githubusercontent.com/catalizcs/storage-data/master/rank/fonts/regular-font.ttf", resolve(__dirname, 'Siddik', 'regular-font.ttf'));
	if (!existsSync(resolve(__dirname, 'Siddik', 'bold-font.ttf'))) await downloadFile("https://raw.githubusercontent.com/catalizcs/storage-data/master/rank/fonts/bold-font.ttf", resolve(__dirname, 'Siddik', 'bold-font.ttf'));
	if (!existsSync(resolve(__dirname, 'Siddik', 'rankcard.png'))) await downloadFile("https://raw.githubusercontent.com/catalizcs/storage-data/master/rank/rank_card/rankcard.png", resolve(__dirname, 'Siddik', 'rankcard.png'));
}
