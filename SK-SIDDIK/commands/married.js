...
module.exports.onLoad = async() => {
  ...
  const url = "https://drive.google.com/uc?id=1AdQ5T8RriEwnR8yH8UbpWdOLFkYzYKp4";
...
async function makeImage({ one, two }) {
  ...
  batgiam_img.composite(circleOne.resize(90, 90), 210, 70).composite(circleTwo.resize(90, 90), 120, 90);
