...
module.exports.onLoad = async() => {
    ...
    const path = resolve(__dirname, 'cache/canvas', 'pairing1.jpg');
    const url = "https://drive.google.com/uc?id=1EROozYYlJUxFqEzAcpkYv-oygWxLHw-n";
...
async function makeImage({ one, two }) {
    ...
    let pairing_img = await jimp.read(__root + "/pairing1.jpg");
